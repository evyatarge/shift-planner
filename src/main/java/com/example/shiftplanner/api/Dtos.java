...
public class Dtos {
    ...
    public record TaskDTO(Long id, String name, LocalDateTime start, LocalDateTime end, Set<String> requiredSkills, int requiredEmployees, Boolean allowEmptySlots, Boolean is24HourTask) {}
    ...
    public record SolveResponse(List<AssignmentDTO> assignments, String score, long unassignedCount, String timestamp) {}
}
