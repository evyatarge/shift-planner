...
export interface Task { id: number; name: string; start: string; end: string; requiredSkills: string[]; requiredEmployees: number; allowEmptySlots?: boolean; is24HourTask?: boolean; }
...
export interface SolveResponse { assignments: AssignmentDTO[]; score: string; unassignedCount: number; timestamp?: string; }
